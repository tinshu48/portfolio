...
var typed = new Typed('.typejs', {
  strings: ["an IT Student " + "<img src='./assets/images/skills_image/cse-student.svg' width='30px'>", "a Python Developer " + "<img src='./assets/images/skills_image/python.svg' width='30px'>", "a Web Developer " + "<img src='./assets/images/skills_image/web-developer.svg' width='30px'>"],
  typeSpeed: 50,
  backSpeed: 50,
  loop: true,
  smartBackspace: true,
